...
const styles = {
  pill: {
    root: 'relative z-20 inline-flex rounded-full border border-[#e6dfcb1f] bg-[#080b0980] p-1',
    button: 'flex items-center gap-2 rounded-full px-4 py-2 text-[11px] tracking-[.18em] transition-all',
    active: 'bg-[#c7a762] text-[#12150f] shadow-[0_5px_18px_#0006]',
    inactive: 'text-[#747b73] hover:text-[#d8d1bf]',
  },
  boxed: {
    root: 'inline-flex rounded-lg border border-[#3a4039] bg-[#111611] p-1',
    button: 'rounded-md px-4 py-2 text-[11px] tracking-[.16em] transition-colors',
